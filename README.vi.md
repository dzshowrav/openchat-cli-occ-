...
1. `$OPENCHAT_INSTALL_DIR` - Thư mục cài đặt tùy chỉnh
2. `$XDG_BIN_DIR` - Đường dẫn tuân thủ XDG Base Directory Specification
3. `$HOME/bin` - Thư mục nhị phân tiêu chuẩn của người dùng (nếu tồn tại hoặc có thể tạo)
4. `$HOME/.openchat/bin` - Mặc định dự phòng
...
Tìm hiểu thêm về [agents](https://openchat.ai/docs/agents).
...
**Tham gia cộng đồng của chúng tôi** [Discord](https://discord.gg/openchat) | [X.com](https://x.com/openchat)
