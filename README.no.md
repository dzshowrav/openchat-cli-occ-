...
1. `$OPENCHAT_INSTALL_DIR` - Egendefinert installasjonsmappe
...
Les mer om [agents](https://openchat.ai/docs/agents).
...
**Bli med i fellesskapet** [Discord](https://discord.gg/openchat) | [X.com](https://x.com/openchat)
