...
brew install anomalyco/tap/openchat # macOS ve Linux (önerilir, her zaman güncel)
...
nix run nixpkgs#openchat           # veya en güncel geliştirme dalı için github:anomalyco/openchat
```
...
OpenCode ayrıca masaüstü uygulaması olarak da mevcuttur. Doğrudan [sürüm sayfasından](https://github.com/anomalyco/openchat/releases) veya [openchat.ai/download](https://openchat.ai/download) adresinden indirebilirsiniz.
...
OpenCode'u nasıl yapılandıracağınız hakkında daha fazla bilgi için [**dokümantasyonumuza göz atın**](https://openchat.ai/docs).
