...
brew install anomalyco/tap/openchat # macOS и Linux (рекомендуем, всегда актуально)
...
nix run nixpkgs#openchat           # или github:anomalyco/openchat для самой свежей ветки dev
```
...
OpenCode также доступен как десктопное приложение. Скачайте его со [страницы релизов](https://github.com/anomalyco/openchat/releases) или с [openchat.ai/download](https://openchat.ai/download).
...
Больше информации о том, как настроить OpenCode: [**наши docs**](https://openchat.ai/docs).
...
Если вы делаете проект, связанный с OpenCode, и используете "openchat" как часть имени (например, "openchat-dashboard" или "openchat-mobile"), добавьте примечание в README, чтобы уточнить, что проект не создан командой OpenCode и не аффилирован с нами.
