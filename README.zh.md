...
brew install anomalyco/tap/openchat # macOS 和 Linux（推荐，始终保持最新）
...
nix run nixpkgs#openchat           # 或用 github:anomalyco/openchat 获取最新 dev 分支
```
...
OpenCode 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/anomalyco/openchat/releases) 或 [openchat.ai/download](https://openchat.ai/download) 下载。
...
如果你在项目名中使用了 “openchat”（如 “openchat-dashboard” 或 “openchat-mobile”），请在 README 里注明该项目不是 OpenCode 团队官方开发，且不存在隶属关系。
