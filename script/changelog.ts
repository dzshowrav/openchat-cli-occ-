...
Generates UPCOMING_CHANGELOG.md by running the openchat changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for openchat run (default: low)
      --quiet            Suppress openchat command output unless it fails
