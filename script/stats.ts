...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/openchat/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/openchat...\n")
...
console.log("Fetching npm all-time downloads for openchat-ai...\n")
const npmDownloads = await fetchNpmDownloads("openchat-ai")
