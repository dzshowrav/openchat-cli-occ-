...
import { compile, emitEffectImported, emitPromise, write } from "@openchat-ai/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@openchat-ai/protocol/groups/event"',
            },
          },
        }),
