import openchatWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/anomalyco/openchat",
  fallbackStars: "150K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "openchat:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://openchat.ai/">
...
function OpenCodeMark() {
  return (
    <svg data-slot="openchat-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://openchat.ai/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://openchat.ai/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@openchat.ai", label: i18n.t("footer.contact") },
    { href: "https://openchat.ai/discord", label: i18n.t("footer.community") },
    { href: "https://x.com/openchat", label: "X" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://openchat.ai" aria-label={i18n.t("footer.homeAria")}>
          <OpenCodeMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={openchatWordmarkDark} alt="OpenCode" />
          <button
