...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new OpenchatClient()" to fix this error.`)
    }
    return instance
  }
...
export class Global extends HeyApiClient {
   ...
   * Upgrade openchat
   *
   * Upgrade openchat to the specified version or latest if not specified.
   */
...
export class OpenchatClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<OpenchatClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    OpenchatClient.__registry.set(this, args?.key)
  }
