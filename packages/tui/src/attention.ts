...
import defaultSoundPath from "@openchat-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@openchat-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@openchat-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@openchat-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@openchat-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@openchat-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "openchat"
const DEFAULT_PACK_ID = "openchat.default"
