...
import { registerOpenchatSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@openchat-ai/sdk/v2"
...
import { OPENCHAT_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useOpenchatKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.OPENCHAT_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
