...
import { useBindings, useOpenchatModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useOpenchatModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.OPENCHAT_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
