...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OPENCHAT.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/openchat/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/openchat (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/openchat/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/openchat/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const OPENCHAT_DB|OPENCHAT_DB|OPENCHAT_DEV|Global\\.Path\\.data|data =" in packages/openchat/src (115 matches)',
  },
] as const
