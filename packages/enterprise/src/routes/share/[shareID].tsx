import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@openchat-ai/sdk/v2"
import { SessionTurn } from "@openchat-ai/session-ui/session-turn"
import { SessionReview } from "@openchat-ai/session-ui/session-review"
import { DataProvider } from "@openchat-ai/session-ui/context"
import { FileComponentProvider } from "@openchat-ai/ui/context/file"
import { WorkerPoolProvider } from "@openchat-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@openchat-ai/ui/logo"
import { IconButton } from "@openchat-ai/ui/icon-button"
import { ProviderIcon } from "@openchat-ai/ui/provider-icon"
import { iife } from "@openchat-ai/core/util/iife"
import { Binary } from "@openchat-ai/core/util/binary"
import { NamedError } from "@openchat-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@openchat-ai/ui/tabs"
import { MessageNav } from "@openchat-ai/session-ui/message-nav"
import { FileSSR } from "@openchat-ai/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@openchat-ai/session-ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/openchat-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })
          ...
          return (
            <>
              ...
              <Meta name="description" content="openchat - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/openchat"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
                              <IconButton
                                as={"a"}
                                href="https://openchat.ai/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
