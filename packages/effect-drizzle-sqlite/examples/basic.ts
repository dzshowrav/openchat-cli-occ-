...
class Database extends Context.Service<Database, DatabaseShape>()("@openchat/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@openchat/example/UserStore") {
