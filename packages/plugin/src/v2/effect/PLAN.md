...
- Effect plugins import `@openchat-ai/plugin/v2/effect`, not `@openchat-ai/core`.
- Public domain values use generated `@openchat-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@openchat-ai/plugin/v2/effect`.
