...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/openchat.git")).toEqual({ owner: "sst", repo: "openchat" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/openchat")).toEqual({ owner: "sst", repo: "openchat" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/openchat.git")).toEqual({ owner: "sst", repo: "openchat" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/openchat")).toEqual({ owner: "sst", repo: "openchat" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/openchat.git")).toEqual({ owner: "sst", repo: "openchat" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/openchat")).toEqual({ owner: "sst", repo: "openchat" })
})
