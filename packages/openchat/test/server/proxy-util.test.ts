...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips openchat-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-openchat-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-openchat-directory")).toBeNull()
      expect(result.get("x-openchat-workspace")).toBeNull()
