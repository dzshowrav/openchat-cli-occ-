...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips openchat-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-openchat-directory"]).toBeUndefined()
      expect(forwarded["x-openchat-workspace"]).toBeUndefined()
