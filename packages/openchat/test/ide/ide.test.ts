...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OPENCHAT_CALLER", () => {
    process.env["OPENCHAT_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OPENCHAT_CALLER", () => {
    process.env["OPENCHAT_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OPENCHAT_CALLER", () => {
    process.env["OPENCHAT_CALLER"] = "unknown"
