...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@openchat/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@openchat/ACPDirectory") {}
