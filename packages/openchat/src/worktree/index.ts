...
import { path } from "@openchat-ai/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@openchat-ai/core/project"
...
import { WorktreeEvent } from "@openchat-ai/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@openchat/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `openchat/${name}`
