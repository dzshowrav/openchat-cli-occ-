...
import { makeApi } from "@openchat-ai/protocol/api"
import { LocationMiddleware } from "@openchat-ai/server/location"
import { SessionLocationMiddleware } from "@openchat-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("openchat-root")
...
export const InstanceHttpApi = HttpApi.make("openchat-instance")
...
export const OpenCodeHttpApi = HttpApi.make("openchat")
