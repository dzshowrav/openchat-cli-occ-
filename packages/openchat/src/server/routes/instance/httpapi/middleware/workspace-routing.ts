...
>()("@openchat/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@openchat/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.OPENCHAT_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.OPENCHAT_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-openchat-directory"] || process.cwd()
}
