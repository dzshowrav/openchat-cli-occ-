...
import { ProjectDirectoryTable, ProjectTable } from "@openchat-ai/core/project/sql"
import { ProjectDirectories } from "@openchat-ai/core/project/directories"
...
import { which } from "@openchat-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@openchat/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.OPENCHAT_FAKE_VCS)
