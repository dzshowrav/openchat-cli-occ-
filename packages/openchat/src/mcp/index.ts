...
import { ConfigMCPV1 } from "@openchat-ai/core/v1/config/mcp"
...
import { McpEvent } from "@openchat-ai/schema/mcp-event"
import { McpBrowser } from "./browser"

const DEFAULT_TIMEOUT = 30_000
const CLIENT_OPTIONS = {
  capabilities: {
    // https://github.com/anomalyco/openchat/issues/11948
    // sampling: {},
    // https://github.com/anomalyco/openchat/issues/23066
    // elicitation: {},
    // https://github.com/anomalyco/openchat/issues/2308
    roots: {},
    // https://github.com/anomalyco/openchat/issues/28567
    // tasks: {},
  },
...
function createClient(directory: string) {
  const client = new Client({ name: "openchat", version: InstallationVersion }, CLIENT_OPTIONS)
            ...
            if (isAuthError) {
              if (lastError.message.includes("registration") || lastError.message.includes("client_id")) {
                ...
                return events
                  .publish(TuiEvent.ToastShow, {
                    title: "MCP Authentication Required",
                    message: `Server "${key}" requires authentication. Run: openchat mcp auth ${key}`,
                    variant: "warning",
                    duration: 8000,
                  })
                  .pipe(Effect.ignore, Effect.as(undefined))
