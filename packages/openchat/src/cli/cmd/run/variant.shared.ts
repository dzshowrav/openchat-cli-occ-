...
//
// The saved variant persists across sessions in ~/.local/state/openchat/model.json
...
class Service extends Context.Service<Service, VariantService>()("@openchat/RunVariant") {}
