...
import { openEditor } from "@openchat-ai/tui/editor"
import { registerOpenchatKeymap } from "@openchat-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerOpenchatKeymap(keymap, renderer, input.tuiConfig)
