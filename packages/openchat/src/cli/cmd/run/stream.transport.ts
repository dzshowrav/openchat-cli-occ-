...
import type { Event, GlobalEvent, OpenchatClient } from "@openchat-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@openchat/RunStreamTransport") {}
