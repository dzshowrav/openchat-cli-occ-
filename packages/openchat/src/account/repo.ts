...
import { AccountStateTable, AccountTable } from "@openchat-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@openchat/AccountRepo") {}
