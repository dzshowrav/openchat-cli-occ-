 ...
 *   "@openchat/ServerAuthConfig",
 *   {
 *     password: Config.string("OPENCHAT_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("OPENCHAT_SERVER_USERNAME").pipe(Config.withDefault("openchat")),
 *   },
 * ) {}
 *
