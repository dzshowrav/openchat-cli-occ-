import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@openchat-ai/llm"
...
// Move this extraction into @openchat-ai/llm when Copilot is handled by the native runtime.
