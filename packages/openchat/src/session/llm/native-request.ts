import type { JsonSchema, LLMRequest, ProviderMetadata } from "@openchat-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@openchat-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @openchat-ai/llm request objects from openchat's session/AI SDK-shaped data.
  return LLM.request({
