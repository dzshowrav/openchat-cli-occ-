...
import { llmClient } from "@openchat-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@openchat-ai/llm"
import { LLMClient } from "@openchat-ai/llm/route"
import type { LLMClientService } from "@openchat-ai/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via openchat's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @openchat-ai/llm. It
