...
import { Slug } from "@openchat-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@openchat-ai/llm"
...
import { locationServiceMapLayer } from "@openchat-ai/core/location-services"
...
import { PartTable, SessionTable } from "@openchat-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@openchat-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".openchat", "plans")
