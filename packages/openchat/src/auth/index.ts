...
import { NonNegativeInt } from "@openchat-ai/core/schema"
import { Global } from "@openchat-ai/core/global"
import { FSUtil } from "@openchat-ai/core/fs-util"

export const OAUTH_DUMMY_KEY = "openchat-oauth-dummy-key"
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const all = Effect.fn("Auth.all")(function* () {
      if (process.env.OPENCHAT_AUTH_CONTENT) {
        try {
          return JSON.parse(process.env.OPENCHAT_AUTH_CONTENT)
        } catch (err) {}
      }
