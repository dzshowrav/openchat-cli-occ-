...
import { EventSequenceTable, EventTable } from "@openchat-ai/core/event/sql"
...
import { WorkspaceEvent } from "@openchat-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@openchat/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        OPENCHAT_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        OPENCHAT_WORKSPACE_ID: config.id,
        OPENCHAT_EXPERIMENTAL_WORKSPACES: "true",
