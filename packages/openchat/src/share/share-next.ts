...
import type * as SDK from "@openchat-ai/sdk/v2"
...
import { SessionShareTable } from "@openchat-ai/core/share/sql"
...
const disabled = process.env["OPENCHAT_DISABLE_SHARE"] === "true" || process.env["OPENCHAT_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@openchat/ShareNext") {}
