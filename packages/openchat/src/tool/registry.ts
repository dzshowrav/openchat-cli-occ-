...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@openchat-ai/plugin"
...
export function webSearchEnabled(providerID: ProviderV2.ID, flags = { exa: false, parallel: false }) {
  return providerID === ProviderV2.ID.openchat || flags.exa || flags.parallel
}
