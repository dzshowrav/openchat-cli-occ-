...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/openchat`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy openchat service removed
