...
Practical reference for the current tool-migration state in `packages/openchat`.
...
Tool tests should use the existing Effect helpers in `packages/openchat/test/lib/effect.ts`:
