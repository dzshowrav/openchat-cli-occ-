...
Schema-first LLM core for openchat. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@openchat-ai/llm"
import { OpenAI } from "@openchat-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@openchat-ai/llm/providers"
