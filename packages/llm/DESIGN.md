...
> current private `@openchat-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@openchat-ai/ai`
...
import { LLM } from "@openchat-ai/ai"
import { OpenAI } from "@openchat-ai/ai/providers/openai"
...
```ts
import { Message } from "@openchat-ai/ai"
...
import { LLM, Tool } from "@openchat-ai/ai"
...
```ts
import { LLM } from "@openchat-ai/ai/promise"
import { OpenAI } from "@openchat-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@openchat-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@openchat-ai/ai/provider"
...
@openchat-ai/ai/promise
  Promise/AsyncIterable LLM facade

@openchat-ai/ai/schema
  serializable domain schemas

@openchat-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@openchat-ai/ai/providers/openai
@openchat-ai/ai/providers/anthropic
@openchat-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@openchat-ai/llm`                      | `@openchat-ai/ai`                                           |
