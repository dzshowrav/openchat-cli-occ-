...
{
  "dependencies": {
    "@openchat-ai/codemode": "workspace:*"
  }
}
```
...
```ts
import { CodeMode, Tool } from "@openchat-ai/codemode"
...
```ts
import { CodeMode, OpenAPI } from "@openchat-ai/codemode"
...
const runtime = CodeMode.make({ tools: { openchat: api.tools } })
...
```ts
import { toolError } from "@openchat-ai/codemode"
