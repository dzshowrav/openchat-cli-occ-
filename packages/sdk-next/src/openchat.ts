import { OpenCode } from "@openchat-ai/client/effect"
...
import { createEmbeddedRoutes } from "@openchat-ai/server/routes"
...
export const create = Effect.fn("OpenCode.create")(function* () {
  ...
  const client = yield* OpenCode.make({ baseUrl: "http://openchat.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@openchat-ai/sdk-next/OpenCode") {}
