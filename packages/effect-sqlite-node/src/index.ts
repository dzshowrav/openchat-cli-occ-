...
export const TypeId: TypeId = "~@openchat-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@openchat-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@openchat-ai/effect-sqlite-node/NodeSqliteClient")
