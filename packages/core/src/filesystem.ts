...
import { Entry, FileSystem, FindInput, Match } from "@openchat-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@openchat-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@openchat/v2/FileSystem") {}
