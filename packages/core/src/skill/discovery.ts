...
export class Service extends Context.Service<Service, Interface>()("@openchat/v2/SkillDiscovery") {}
      ...
      pull: Effect.fn("SkillDiscovery.pull")(function* (url) {
        ...
        return yield* Effect.forEach(
          data.skills.flatMap((skill) => {
            ...
            const versionFile = path.join(root, ".openchat-version")
            ...
            Effect.gen(function* () {
              ...
              if (version === undefined || current === version) {
                ...
                yield* Effect.gen(function* () {
                  ...
                  if (!exists) return
                  yield* fs.writeFileString(path.join(staging, ".openchat-version"), version)
