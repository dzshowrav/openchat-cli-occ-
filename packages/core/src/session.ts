...
import { ListAnchor } from "@openchat-ai/schema/session"
...
import { PromptInput } from "@openchat-ai/schema/prompt-input"
...
import { SessionDurable } from "@openchat-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@openchat/v2/Session") {}
