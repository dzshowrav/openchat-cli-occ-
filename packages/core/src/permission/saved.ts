...
import { PermissionSaved } from "@openchat-ai/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@openchat/v2/PermissionSaved") {}
