...
import type { Plugin as PluginRuntime } from "@openchat-ai/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@openchat/v2/Plugin") {}
