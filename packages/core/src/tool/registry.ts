...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@openchat-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@openchat/v2/ToolRegistry") {}
