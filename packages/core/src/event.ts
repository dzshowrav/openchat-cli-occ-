...
import type { Data, Definition, Payload } from "@openchat-ai/schema/event"
...
import { Durable } from "@openchat-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@openchat-ai/schema/event").ID
export type { Data, Definition, Payload } from "@openchat-ai/schema/event"
