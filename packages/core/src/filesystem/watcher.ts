...
import { FileSystemWatcher } from "@openchat-ai/schema/filesystem-watcher"
...
declare const OPENCHAT_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof OPENCHAT_LIBC === "undefined" ? undefined : OPENCHAT_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@openchat/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.OPENCHAT_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.OPENCHAT_EXPERIMENTAL_FILEWATCHER)) {
