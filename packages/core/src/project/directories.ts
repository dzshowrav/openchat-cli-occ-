...
import type { EffectDrizzleSqlite } from "@openchat-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@openchat/ProjectDirectories") {}
