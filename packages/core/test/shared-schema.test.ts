...
import { AgentAttachment, FileAttachment, Prompt, Source } from "@openchat-ai/schema/prompt"
import { Provider } from "@openchat-ai/schema/provider"
import { Project } from "@openchat-ai/schema/project"
import { ProjectDirectories } from "@openchat-ai/schema/project-directories"
import { PermissionV1 } from "@openchat-ai/schema/permission-v1"
...
import { Command } from "@openchat-ai/schema/command"
import { Connection } from "@openchat-ai/schema/connection"
import { Credential } from "@openchat-ai/schema/credential"
import { FileSystem } from "@openchat-ai/schema/filesystem"
import { Integration } from "@openchat-ai/schema/integration"
import { LLM } from "@openchat-ai/schema/llm"
import { Permission } from "@openchat-ai/schema/permission"
import { Plugin } from "@openchat-ai/schema/plugin"
import { Pty } from "@openchat-ai/schema/pty"
import { Reference } from "@openchat-ai/schema/reference"
import { SessionTodo } from "@openchat-ai/schema/session-todo"
import { Skill } from "@openchat-ai/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@openchat-ai/schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@openchat-ai/core/command"),
    import("@openchat-ai/core/integration/connection"),
    import("@openchat-ai/core/credential"),
    import("@openchat-ai/core/filesystem"),
    import("@openchat-ai/core/integration"),
    import("@openchat-ai/core/location"),
    import("@openchat-ai/llm"),
    import("@openchat-ai/core/permission"),
    import("@openchat-ai/core/v1/permission"),
    import("@openchat-ai/core/project/copy"),
    import("@openchat-ai/core/pty"),
    import("@openchat-ai/core/project/schema"),
    import("@openchat-ai/core/reference"),
    import("@openchat-ai/core/session/input"),
    import("@openchat-ai/core/session/message"),
    import("@openchat-ai/core/session/todo"),
    import("@openchat-ai/core/session/prompt"),
    import("@openchat-ai/core/skill"),
    import("@openchat-ai/core/v2-schema"),
    import("@openchat-ai/core/schema"),
    import("@openchat-ai/core/workspace"),
  ])
