import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@openchat-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
