...
beforeAll(async () => {
  ...
  mock.module("@openchat-ai/sdk/v2/client", () => ({
    createOpenchatClient: (input: { directory: string }) => {
      createdClients.push(input.directory)
      return clientFor(input.directory)
    },
  }))

  mock.module("@openchat-ai/ui/toast", () => ({
    Toast: { Region: () => null },
    showToast: () => 0,
  }))

  mock.module("@openchat-ai/core/util/encode", () => ({
