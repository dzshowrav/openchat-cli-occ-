...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "openchat", key: "dialog.provider.openchat.note" },
  { match: (id: string) => id === "openchat-go", key: "dialog.provider.openchatGo.tagline" },
...
export const SettingsProvidersV2: Component<{ onBack?: () => void }> = (props) => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "openchat" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "openchat" || item.id === "openchat-go"}>
