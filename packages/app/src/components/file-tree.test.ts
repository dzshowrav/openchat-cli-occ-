...
beforeAll(async () => {
  ...
  mock.module("@openchat-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@openchat-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@openchat-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@openchat-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
