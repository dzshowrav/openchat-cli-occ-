...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "OpenCode Documentation", href: "https://openchat.ai/docs" },
      { type: "item", label: "Support Forum", href: "https://discord.com/invite/openchat" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/anomalyco/openchat/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/anomalyco/openchat/issues/new?template=bug_report.yml",
      },
    ],
  },
]
