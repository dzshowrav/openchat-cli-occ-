...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: OpenchatClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadMcpResourcesQuery = (scope: ServerScope, directory: string, sdk: OpenchatClient) =>
...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: OpenchatClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => OpenchatClient,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, OpenchatClient>()
