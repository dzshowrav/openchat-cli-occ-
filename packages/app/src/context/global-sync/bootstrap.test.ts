...
import type { Config, OpenchatClient, Project, Session } from "@openchat-ai/sdk/v2/client"
import type { NormalizedProviderListResponse } from "@openchat-ai/session-ui/context"
...
describe("query keys", () => {
  test("partitions identical directories by server scope", () => {
    const client = {} as OpenchatClient
