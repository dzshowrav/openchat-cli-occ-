...
import { Session } from "@openchat-ai/sdk/v2/client"
...
import { toaster } from "@openchat-ai/ui/toast"
...
import { retry } from "@openchat-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@openchat-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://openchat.ai/desktop-feedback")}
      renderPanel={() =>
