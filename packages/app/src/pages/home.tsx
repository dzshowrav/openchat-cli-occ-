...
import { Logo } from "@openchat-ai/ui/logo"
import { Spinner } from "@openchat-ai/ui/spinner"
import { ScrollView } from "@openchat-ai/ui/scroll-view"
import { ProjectAvatar } from "@openchat-ai/ui/v2/project-avatar-v2"
...
import { base64Encode } from "@openchat-ai/core/util/encode"
...
import { useMarked } from "@openchat-ai/ui/context/marked"
import { preloadMarkdown } from "@openchat-ai/session-ui/markdown-cache"
      ...
      >
        <div class="mx-auto grid min-h-full w-full max-w-[1080px] grid-rows-[auto_minmax(0,1fr)_auto] gap-4 px-3 lg:grid-cols-[280px_minmax(0,720px)] lg:grid-rows-1 lg:gap-8 lg:px-6">
          <HomeProjectColumn
            ...
            openHelp={() => platform.openLink("https://openchat.ai/desktop-feedback")}
            language={language}
            onWheel={(event) => {
