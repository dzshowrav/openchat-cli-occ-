...
import type { FileSearchHandle } from "@openchat-ai/session-ui/file"
import { useFileComponent } from "@openchat-ai/ui/context/file"
import { cloneSelectedLineRange, previewSelectedLines } from "@openchat-ai/session-ui/pierre/selection-bridge"
import { createLineCommentController } from "@openchat-ai/session-ui/line-comment-annotations"
import { createLineCommentControllerV2 } from "@openchat-ai/session-ui/v2/line-comment-annotations-v2"
import { sampledChecksum } from "@openchat-ai/core/util/encode"
import { normalize, text } from "@openchat-ai/session-ui/session-diff"
import { DropdownMenu } from "@openchat-ai/ui/dropdown-menu"
import { IconButton } from "@openchat-ai/ui/icon-button"
import { LineCommentV2OverflowIcon } from "@openchat-ai/ui/v2/line-comment-v2"
  ...
  const renderFile = (source: string) => (
    <div class="relative overflow-hidden pb-40">
      <Dynamic
        ...
        search={search}
        class="select-text [--openchat-diffs-bg:var(--v2-background-bg-base)]"
        media={{
          mode: "auto",
          path: path(),
