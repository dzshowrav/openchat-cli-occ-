...
const GLOBAL_STORAGE = "openchat.global.dat"
const WINDOW_STORAGE = "openchat.window"
const LOCAL_PREFIX = "openchat."
...
function workspaceStorage(dir: string) {
  ...
  return `openchat.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `openchat.draft.${head}.${sum}.dat`
}
