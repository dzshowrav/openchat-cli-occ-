...
export type WslJob =
  ...
  | { kind: "install-openchat"; distro: string; startedAt: number }
...
export type WslServersState = {
  ...
  openchatChecks: Record<string, WslOpenchatCheck>
...
export type WslServersPlatform = {
  ...
  installOpenchat(name: string): Promise<void>
