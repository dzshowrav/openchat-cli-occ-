export const dict = {
  ...
  "dialog.provider.openchat.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.openchat.tagline": "Modelos optimizados y fiables",
  "dialog.provider.openchatGo.tagline": "Suscripción económica para todos",
  ...
  "provider.connect.openchatZen.visit.prefix": "Visita ",
  "provider.connect.openchatZen.visit.link": "openchat.ai/zen",
  "provider.connect.openchatZen.visit.suffix": " para obtener tu clave API.",
  ...
  "dialog.plugins.empty": "Plugins configurados en openchat.json",
  ...
  "wsl.onboarding.checkingOpenchat": "Comprobando OpenCode...",
  "wsl.onboarding.checkingOpenchatIn": "Comprobando OpenCode en {{distro}}...",
  "wsl.onboarding.updatingOpenchat": "Actualizando OpenCode...",
  "wsl.onboarding.updatingOpenchatIn": "Actualizando OpenCode en {{distro}}...",
  "wsl.onboarding.updateOpenchatIn": "Actualiza OpenCode en {{distro}}.",
  "wsl.onboarding.updateOpenchat": "Actualizar OpenCode",
  "wsl.onboarding.openchatReadyIn": "OpenCode está listo en {{distro}}.",
  "wsl.onboarding.openchatReady": "OpenCode está listo.",
  "wsl.onboarding.installOpenchatIn": "Instala OpenCode en {{distro}}.",
  "wsl.onboarding.installOpenchat": "Instalar OpenCode",
  ...
  "wsl.onboarding.distroStatus.openchatMissing": "OpenCode no está instalado",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (openchat.json)",
