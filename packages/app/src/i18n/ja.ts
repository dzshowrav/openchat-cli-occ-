export const dict = {
  ...
  "dialog.provider.openchat.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.openchat.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.openchatGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "provider.connect.openchatZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.openchatZen.visit.prefix": " ",
  "provider.connect.openchatZen.visit.link": "openchat.ai/zen",
  "provider.connect.openchatZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  ...
  "dialog.plugins.empty": "openchat.jsonで設定されたプラグイン",
  ...
  "wsl.onboarding.checkingOpenchat": "OpenCodeを確認中...",
  "wsl.onboarding.checkingOpenchatIn": "{{distro}}内のOpenCodeを確認中...",
  "wsl.onboarding.updatingOpenchat": "OpenCodeを更新中...",
  "wsl.onboarding.updatingOpenchatIn": "{{distro}}内のOpenCodeを更新中...",
  "wsl.onboarding.updateOpenchatIn": "{{distro}}内のOpenCodeを更新してください。",
  "wsl.onboarding.updateOpenchat": "OpenCodeを更新",
  "wsl.onboarding.openchatReadyIn": "{{distro}}内のOpenCodeの準備ができました。",
  "wsl.onboarding.openchatReady": "OpenCodeの準備ができました。",
  "wsl.onboarding.installOpenchatIn": "{{distro}}にOpenCodeをインストールしてください。",
  "wsl.onboarding.installOpenchat": "OpenCodeをインストール",
  ...
  "wsl.onboarding.distroStatus.openchatMissing": "OpenCodeがインストールされていません",
  ...
  "error.chain.checkConfig": "config (openchat.json) のプロバイダー/モデル名を確認してください",
