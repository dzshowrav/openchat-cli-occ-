export const dict = {
  ...
  "dialog.provider.openchat.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.openchat.tagline": "Modèles optimisés et fiables",
  "dialog.provider.openchatGo.tagline": "Abonnement abordable pour tous",
  ...
  "provider.connect.openchatZen.visit.prefix": "Visitez ",
  "provider.connect.openchatZen.visit.link": "openchat.ai/zen",
  "provider.connect.openchatZen.visit.suffix": " pour récupérer votre clé API.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans openchat.json",
  ...
  "wsl.onboarding.checkingOpenchat": "Vérification d'OpenCode...",
  "wsl.onboarding.checkingOpenchatIn": "Vérification d'OpenCode dans {{distro}}...",
  "wsl.onboarding.updatingOpenchat": "Mise à jour d'OpenCode...",
  "wsl.onboarding.updatingOpenchatIn": "Mise à jour d'OpenCode dans {{distro}}...",
  "wsl.onboarding.updateOpenchatIn": "Mettez à jour OpenCode dans {{distro}}.",
  "wsl.onboarding.updateOpenchat": "Mettre à jour OpenCode",
  "wsl.onboarding.openchatReadyIn": "OpenCode est prêt dans {{distro}}.",
  "wsl.onboarding.openchatReady": "OpenCode est prêt.",
  "wsl.onboarding.installOpenchatIn": "Installez OpenCode dans {{distro}}.",
  "wsl.onboarding.installOpenchat": "Installer OpenCode",
  ...
  "wsl.onboarding.distroStatus.openchatMissing": "OpenCode non installé",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (openchat.json) pour les noms de fournisseur/modèle",
