...
export const dict = {
  ...
  "dialog.provider.openchat.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.openchat.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.openchatGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "provider.connect.openchatZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.openchatZen.visit.link": "openchat.ai/zen",
  "provider.connect.openchatZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  ...
  "dialog.plugins.empty": "In openchat.json konfigurierte Plugins",
  ...
  "wsl.onboarding.checkingOpenchat": "OpenCode wird geprüft...",
  "wsl.onboarding.checkingOpenchatIn": "OpenCode in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpenchat": "OpenCode wird aktualisiert...",
  "wsl.onboarding.updatingOpenchatIn": "OpenCode in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpenchatIn": "Aktualisieren Sie OpenCode in {{distro}}.",
  "wsl.onboarding.updateOpenchat": "OpenCode aktualisieren",
  "wsl.onboarding.openchatReadyIn": "OpenCode ist in {{distro}} bereit.",
  "wsl.onboarding.openchatReady": "OpenCode ist bereit.",
  "wsl.onboarding.installOpenchatIn": "Installieren Sie OpenCode in {{distro}}.",
  "wsl.onboarding.installOpenchat": "OpenCode installieren",
  ...
  "wsl.onboarding.distroStatus.openchatMissing": "OpenCode nicht installiert",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (openchat.json) auf Anbieter-/Modellnamen",
