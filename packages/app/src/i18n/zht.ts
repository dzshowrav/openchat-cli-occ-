...
export const dict = {
  ...
  "dialog.provider.openchat.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.openchat.tagline": "可靠的優化模型",
  "dialog.provider.openchatGo.tagline": "適合所有人的低成本訂閱",
  ...
  "provider.connect.openchatZen.line1": "OpenCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.openchatZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.openchatZen.visit.prefix": "造訪 ",
  "provider.connect.openchatZen.visit.link": "openchat.ai/zen",
  "provider.connect.openchatZen.visit.suffix": " 取得你的 API 金鑰。",
  ...
  "dialog.plugins.empty": "在 openchat.json 中設定的外掛程式",
  ...
  "wsl.onboarding.checkingOpenchat": "正在檢查 OpenCode...",
  "wsl.onboarding.checkingOpenchatIn": "正在檢查 {{distro}} 中的 OpenCode...",
  "wsl.onboarding.updatingOpenchat": "正在更新 OpenCode...",
  "wsl.onboarding.updatingOpenchatIn": "正在更新 {{distro}} 中的 OpenCode...",
  "wsl.onboarding.updateOpenchatIn": "更新 {{distro}} 中的 OpenCode。",
  "wsl.onboarding.updateOpenchat": "更新 OpenCode",
  "wsl.onboarding.openchatReadyIn": "{{distro}} 中的 OpenCode 已就緒。",
  "wsl.onboarding.openchatReady": "OpenCode 已就緒。",
  "wsl.onboarding.installOpenchatIn": "在 {{distro}} 中安裝 OpenCode。",
  "wsl.onboarding.installOpenchat": "安裝 OpenCode",
  ...
  "wsl.onboarding.distroStatus.openchatMissing": "未安裝 OpenCode",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (openchat.json) 中的 provider/model 名稱",
