export const dict = {
  ...
  "dialog.provider.openchat.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.openchat.tagline": "신뢰할 수 있는 최적화 모델",
  "dialog.provider.openchatGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "provider.connect.openchatZen.line2": "단일 API 키로 Claude, GPT, Gemini, GLM 등 다양한 모델에 액세스할 수 있습니다.",
  "provider.connect.openchatZen.visit.prefix": "다음 ",
  "provider.connect.openchatZen.visit.link": "openchat.ai/zen",
  "provider.connect.openchatZen.visit.suffix": "을 방문하여 API 키를 받으세요.",
  ...
  "dialog.plugins.empty": "openchat.json에 구성된 플러그인",
  ...
  "error.chain.checkConfig": "구성(openchat.json)의 공급자/모델 이름을 확인하세요",
  ...
  "wsl.onboarding.checkingOpenchat": "OpenCode 확인 중...",
  "wsl.onboarding.checkingOpenchatIn": "{{distro}}에서 OpenCode 확인 중...",
  "wsl.onboarding.updatingOpenchat": "OpenCode 업데이트 중...",
  "wsl.onboarding.updatingOpenchatIn": "{{distro}}에서 OpenCode 업데이트 중...",
  "wsl.onboarding.updateOpenchatIn": "{{distro}}에서 OpenCode를 업데이트하세요.",
  "wsl.onboarding.updateOpenchat": "OpenCode 업데이트",
  "wsl.onboarding.openchatReadyIn": "{{distro}}에서 OpenCode를 사용할 준비가 되었습니다.",
  "wsl.onboarding.openchatReady": "OpenCode가 준비되었습니다.",
  "wsl.onboarding.installOpenchatIn": "{{distro}}에 OpenCode를 설치하세요.",
  "wsl.onboarding.installOpenchat": "OpenCode 설치",
  ...
  "wsl.onboarding.distroStatus.openchatMissing": "OpenCode가 설치되지 않음",
