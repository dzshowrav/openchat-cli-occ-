...
export const dict = {
  ...
  "dialog.provider.openchat.note": "使用 OpenCode Zen 或 API 密钥连接",
  "dialog.provider.openchat.tagline": "可靠的优化模型",
  "dialog.provider.openchatGo.tagline": "适合所有人的低成本订阅",
  ...
  "provider.connect.openchatZen.line1": "OpenCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.openchatZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.openchatZen.visit.prefix": "访问 ",
  "provider.connect.openchatZen.visit.link": "openchat.ai/zen",
  "provider.connect.openchatZen.visit.suffix": " 获取你的 API 密钥。",
  ...
  "dialog.plugins.empty": "在 openchat.json 中配置的插件",
  ...
  "wsl.onboarding.checkingOpenchat": "正在检查 OpenCode...",
  "wsl.onboarding.checkingOpenchatIn": "正在检查 {{distro}} 中的 OpenCode...",
  ...
  "wsl.onboarding.openchatReadyIn": "{{distro}} 中的 OpenCode 已就绪。",
  "wsl.onboarding.openchatReady": "OpenCode 已就绪。",
  "wsl.onboarding.installOpenchatIn": "在 {{distro}} 中安装 OpenCode。",
  "wsl.onboarding.installOpenchat": "安装 OpenCode",
  ...
  "wsl.onboarding.distroStatus.openchatMissing": "未安装 OpenCode",
  ...
  "error.chain.checkConfig": "请检查你的配置 (openchat.json) 中的 provider/model 名称",
