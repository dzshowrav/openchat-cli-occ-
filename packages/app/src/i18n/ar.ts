export const dict = {
  ...
  "dialog.provider.openchat.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.openchat.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.openchatGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "provider.connect.openchatZen.visit.prefix": "قم بزيارة ",
  "provider.connect.openchatZen.visit.link": "openchat.ai/zen",
  "provider.connect.openchatZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في openchat.json",
  ...
  "wsl.onboarding.checkingOpenchat": "جارٍ التحقق من OpenCode...",
  "wsl.onboarding.checkingOpenchatIn": "جارٍ التحقق من OpenCode في {{distro}}...",
  "wsl.onboarding.updatingOpenchat": "جارٍ تحديث OpenCode...",
  "wsl.onboarding.updatingOpenchatIn": "جارٍ تحديث OpenCode في {{distro}}...",
  "wsl.onboarding.updateOpenchatIn": "حدّث OpenCode في {{distro}}.",
  "wsl.onboarding.updateOpenchat": "تحديث OpenCode",
  "wsl.onboarding.openchatReadyIn": "OpenCode جاهز في {{distro}}.",
  "wsl.onboarding.openchatReady": "OpenCode جاهز.",
  "wsl.onboarding.installOpenchatIn": "ثبّت OpenCode في {{distro}}.",
  "wsl.onboarding.installOpenchat": "تثبيت OpenCode",
  ...
  "wsl.onboarding.distroStatus.openchatMissing": "OpenCode غير مثبت",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (openchat.json)",
