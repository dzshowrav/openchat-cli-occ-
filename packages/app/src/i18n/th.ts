export const dict = {
  ...
  "dialog.provider.openchat.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.openchat.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.openchatGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "provider.connect.openchatZen.visit.prefix": "เยี่ยมชม ",
  "provider.connect.openchatZen.visit.link": "openchat.ai/zen",
  "provider.connect.openchatZen.visit.suffix": " เพื่อรวบรวมคีย์ API ของคุณ",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน openchat.json",
  ...
  "wsl.onboarding.checkingOpenchat": "กำลังตรวจสอบ OpenCode...",
  "wsl.onboarding.checkingOpenchatIn": "กำลังตรวจสอบ OpenCode ใน {{distro}}...",
  "wsl.onboarding.updatingOpenchat": "กำลังอัปเดต OpenCode...",
  "wsl.onboarding.updatingOpenchatIn": "กำลังอัปเดต OpenCode ใน {{distro}}...",
  "wsl.onboarding.updateOpenchatIn": "อัปเดต OpenCode ใน {{distro}}.",
  "wsl.onboarding.updateOpenchat": "อัปเดต OpenCode",
  "wsl.onboarding.openchatReadyIn": "OpenCode พร้อมใช้งานใน {{distro}} แล้ว.",
  "wsl.onboarding.openchatReady": "OpenCode พร้อมใช้งานแล้ว.",
  "wsl.onboarding.installOpenchatIn": "ติดตั้ง OpenCode ใน {{distro}}.",
  "wsl.onboarding.installOpenchat": "ติดตั้ง OpenCode",
  ...
  "wsl.onboarding.distroStatus.openchatMissing": "ยังไม่ได้ติดตั้ง OpenCode",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (openchat.json) ชื่อผู้ให้บริการ/โมเดล",
