export const dict = {
  ...
  "dialog.provider.openchat.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.openchat.tagline": "Reliable optimized models",
  "dialog.provider.openchatGo.tagline": "Low cost subscription for everyone",
  ...
  "provider.connect.openchatZen.visit.prefix": "Visit ",
  "provider.connect.openchatZen.visit.link": "openchat.ai/zen",
  "provider.connect.openchatZen.visit.suffix": " to collect your API key.",
  ...
  "dialog.plugins.empty": "Plugins configured in openchat.json",
  ...
  "wsl.onboarding.checkingOpenchat": "Checking OpenCode...",
  "wsl.onboarding.checkingOpenchatIn": "Checking OpenCode in {{distro}}...",
  "wsl.onboarding.updatingOpenchat": "Updating OpenCode...",
  "wsl.onboarding.updatingOpenchatIn": "Updating OpenCode in {{distro}}...",
  "wsl.onboarding.updateOpenchatIn": "Update OpenCode in {{distro}}.",
  "wsl.onboarding.updateOpenchat": "Update OpenCode",
  "wsl.onboarding.openchatReadyIn": "OpenCode is ready in {{distro}}.",
  "wsl.onboarding.openchatReady": "OpenCode is ready.",
  "wsl.onboarding.installOpenchatIn": "Install OpenCode in {{distro}}.",
  "wsl.onboarding.installOpenchat": "Install OpenCode",
  ...
  "wsl.onboarding.distroStatus.openchatMissing": "OpenCode not installed",
  ...
  "error.chain.checkConfig": "Check your config (openchat.json) provider/model names",
