export const dict = {
  ...
  "dialog.provider.openchat.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.openchat.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.openchatGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "provider.connect.openchatZen.line1":
    "OpenCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.openchatZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.openchatZen.visit.prefix": "Odwiedź ",
  "provider.connect.openchatZen.visit.link": "openchat.ai/zen",
  "provider.connect.openchatZen.visit.suffix": ", aby odebrać swój klucz API.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w openchat.json",
  ...
  "wsl.onboarding.step.openchat": "OpenCode",
  ...
  "wsl.onboarding.checkingOpenchat": "Sprawdzanie OpenCode...",
  "wsl.onboarding.checkingOpenchatIn": "Sprawdzanie OpenCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpenchat": "Aktualizowanie OpenCode...",
  "wsl.onboarding.updatingOpenchatIn": "Aktualizowanie OpenCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpenchatIn": "Zaktualizuj OpenCode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpenchat": "Zaktualizuj OpenCode",
  "wsl.onboarding.openchatReadyIn": "OpenCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.openchatReady": "OpenCode jest gotowy.",
  "wsl.onboarding.installOpenchatIn": "Zainstaluj OpenCode w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpenchat": "Zainstaluj OpenCode",
  ...
  "wsl.onboarding.distroStatus.openchatMissing": "OpenCode nie jest zainstalowany",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (openchat.json) nazwy dostawców/modeli",
