...
export const dict = {
  ...
  "dialog.provider.openchat.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.openchat.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.openchatGo.tagline": "Rimelig abonnement for alle",
  ...
  "provider.connect.openchatZen.visit.prefix": "Besøk ",
  "provider.connect.openchatZen.visit.link": "openchat.ai/zen",
  "provider.connect.openchatZen.visit.suffix": " for å hente API-nøkkelen din.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i openchat.json",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (openchat.json)",
  ...
  "wsl.onboarding.checkingOpenchat": "Sjekker OpenCode...",
  "wsl.onboarding.checkingOpenchatIn": "Sjekker OpenCode i {{distro}}...",
  "wsl.onboarding.updatingOpenchat": "Oppdaterer OpenCode...",
  "wsl.onboarding.updatingOpenchatIn": "Oppdaterer OpenCode i {{distro}}...",
  "wsl.onboarding.updateOpenchatIn": "Oppdater OpenCode i {{distro}}.",
  "wsl.onboarding.updateOpenchat": "Oppdater OpenCode",
  "wsl.onboarding.openchatReadyIn": "OpenCode er klar i {{distro}}.",
  "wsl.onboarding.openchatReady": "OpenCode er klar.",
  "wsl.onboarding.installOpenchatIn": "Installer OpenCode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.openchatMissing": "OpenCode er ikke installert",
