...
export const dict = {
  ...
  "dialog.provider.openchat.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.openchat.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.openchatGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "provider.connect.openchatZen.visit.prefix": "",
  "provider.connect.openchatZen.visit.link": "openchat.ai/zen",
  "provider.connect.openchatZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "dialog.plugins.empty": "Eklentiler openchat.json içinde yapılandırılır",
  ...
  "wsl.onboarding.checkingOpenchat": "OpenCode kontrol ediliyor...",
  "wsl.onboarding.checkingOpenchatIn": "{{distro}} içinde OpenCode kontrol ediliyor...",
  "wsl.onboarding.updatingOpenchat": "OpenCode güncelleniyor...",
  "wsl.onboarding.updatingOpenchatIn": "{{distro}} içinde OpenCode güncelleniyor...",
  "wsl.onboarding.updateOpenchatIn": "{{distro}} içindeki OpenCode'u güncelleyin.",
  "wsl.onboarding.updateOpenchat": "OpenCode'u güncelle",
  "wsl.onboarding.openchatReadyIn": "{{distro}} içinde OpenCode hazır.",
  "wsl.onboarding.openchatReady": "OpenCode hazır.",
  "wsl.onboarding.installOpenchatIn": "OpenCode'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpenchat": "OpenCode'u kur",
  ...
  "wsl.onboarding.distroStatus.openchatMissing": "OpenCode kurulu değil",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (openchat.json) sağlayıcı/model adlarını kontrol edin",
