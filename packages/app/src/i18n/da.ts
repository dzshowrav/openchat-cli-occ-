export const dict = {
  ...
  "dialog.provider.openchat.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.openchat.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.openchatGo.tagline": "Billigt abonnement for alle",
  ...
  "provider.connect.openchatZen.visit.prefix": "Besøg ",
  "provider.connect.openchatZen.visit.link": "openchat.ai/zen",
  "provider.connect.openchatZen.visit.suffix": " for at hente din API-nøgle.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i openchat.json",
  ...
  "wsl.onboarding.checkingOpenchat": "Tjekker OpenCode...",
  "wsl.onboarding.checkingOpenchatIn": "Tjekker OpenCode i {{distro}}...",
  "wsl.onboarding.updatingOpenchat": "Opdaterer OpenCode...",
  "wsl.onboarding.updatingOpenchatIn": "Opdaterer OpenCode i {{distro}}...",
  "wsl.onboarding.updateOpenchatIn": "Opdater OpenCode i {{distro}}.",
  "wsl.onboarding.updateOpenchat": "Opdater OpenCode",
  ...
  "wsl.onboarding.distroStatus.openchatMissing": "OpenCode er ikke installeret",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (openchat.json) udbyder/modelnavne",
