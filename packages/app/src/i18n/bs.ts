export const dict = {
  ...
  "dialog.provider.openchat.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.openchat.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.openchatGo.tagline": "Povoljna pretplata za sve",
  ...
  "provider.connect.openchatZen.visit.prefix": "Posjeti ",
  "provider.connect.openchatZen.visit.link": "openchat.ai/zen",
  "provider.connect.openchatZen.visit.suffix": " da preuzmeš svoj API ključ.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u openchat.json",
  ...
  "wsl.onboarding.checkingOpenchat": "Provjera OpenCode...",
  "wsl.onboarding.checkingOpenchatIn": "Provjera OpenCode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpenchat": "Ažuriranje OpenCode...",
  "wsl.onboarding.updatingOpenchatIn": "Ažuriranje OpenCode u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpenchatIn": "Ažuriraj OpenCode u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpenchat": "Ažuriraj OpenCode",
  "wsl.onboarding.openchatReadyIn": "OpenCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.openchatReady": "OpenCode je spreman.",
  "wsl.onboarding.installOpenchatIn": "Instaliraj OpenCode u distribuciji {{distro}}.",
  "wsl.onboarding.installOpenchat": "Instaliraj OpenCode",
  ...
  "wsl.onboarding.distroStatus.openchatMissing": "OpenCode nije instaliran",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (openchat.json) provider/model names",
