export const dict = {
  ...
  "dialog.provider.openchat.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.openchat.tagline": "Надежные оптимизированные модели",
  "dialog.provider.openchatGo.tagline": "Доступная подписка для всех",
  ...
  "provider.connect.openchatZen.visit.prefix": "Посетите ",
  "provider.connect.openchatZen.visit.link": "openchat.ai/zen",
  "provider.connect.openchatZen.visit.suffix": " чтобы получить ваш API ключ.",
  ...
  "dialog.plugins.empty": "Плагины настроены в openchat.json",
  ...
  "wsl.onboarding.checkingOpenchat": "Проверка OpenCode...",
  "wsl.onboarding.checkingOpenchatIn": "Проверка OpenCode в {{distro}}...",
  "wsl.onboarding.updatingOpenchat": "Обновление OpenCode...",
  "wsl.onboarding.updatingOpenchatIn": "Обновление OpenCode в {{distro}}...",
  "wsl.onboarding.updateOpenchatIn": "Обновите OpenCode в {{distro}}.",
  "wsl.onboarding.updateOpenchat": "Обновить OpenCode",
  "wsl.onboarding.openchatReadyIn": "OpenCode в {{distro}} готов к работе.",
  "wsl.onboarding.openchatReady": "OpenCode готов к работе.",
  "wsl.onboarding.installOpenchatIn": "Установите OpenCode в {{distro}}.",
  "wsl.onboarding.installOpenchat": "Установить OpenCode",
  ...
  "wsl.onboarding.distroStatus.openchatMissing": "OpenCode не установлен",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (openchat.json)",
