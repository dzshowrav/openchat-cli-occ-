...
import { IconOpenchat } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "openchat/session/message-v2"
import type { Message } from "openchat/session/message"
import type { Session } from "openchat/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.openchat_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.openchat_name}>
                    <IconOpenchat width={16} height={16} />
                  </div>
