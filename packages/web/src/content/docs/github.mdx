...
OpenCode integrates with your GitHub workflow. Mention `/openchat` or `/oc` in your comment, and OpenCode will execute tasks within your GitHub Actions runner.
...
1. **Install the GitHub app**
   ...
   Head over to [**github.com/apps/openchat-agent**](https://github.com/apps/openchat-agent). Make sure it's installed on the target repository.

2. **Add the workflow**

   Add the following workflow file to `.github/workflows/openchat.yml` in your repo. Make sure to set the appropriate `model` and required API keys in `env`.
...
| ----------------------------- | -------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| `issue_comment`               | Comment on an issue or PR              | Mention `/openchat` or `/oc` in your comment. OpenCode reads context and can create branches, open PRs, or reply. |
| `pull_request_review_comment` | Comment on specific code lines in a PR | Mention `/openchat` or `/oc` while reviewing code. OpenCode receives file path, line numbers, and diff context.   |
