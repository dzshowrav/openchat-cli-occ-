...
Dies ist getrennt von `openchat.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `OPENCHAT_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
...
- `sound_pack` - Zu verwendende sound pack ID. Standard ist `openchat.default`.
