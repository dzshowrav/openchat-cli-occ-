...
Die [Modell-ID](/docs/config/#models) in deiner OpenCode Config verwendet das Format `openchat-go/<model-id>`. Für Kimi K3 würdest du beispielsweise `openchat-go/kimi-k3` in deiner Config verwenden.
