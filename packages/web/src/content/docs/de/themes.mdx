...
Standardmaessig verwendet OpenCode das `openchat`-Theme.
...
2. **Benutzer-Config-Verzeichnis** - Definiert in `~/.config/openchat/themes/*.json` oder `$XDG_CONFIG_HOME/openchat/themes/*.json`
3. **Projekt-Root-Verzeichnis** - Definiert in `<project-root>/.openchat/themes/*.json`
4. **Aktuelles Arbeitsverzeichnis** - Definiert in `./.openchat/themes/*.json`
