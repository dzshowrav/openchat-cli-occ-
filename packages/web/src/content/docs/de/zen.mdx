...
Die [Model-ID](/docs/config/#models) in deiner OpenCode-Konfiguration verwendet das Format `openchat/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `openchat/gpt-5.5` in deiner Konfiguration verwenden.
