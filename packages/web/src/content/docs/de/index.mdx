...
![OpenCode TUI with the openchat theme](../../../assets/lander/screenshot.png)
...
- **Homebrew unter macOS und Linux verwenden**
  ...
  > Wir empfehlen die Verwendung des OpenCode-Taps für die aktuellsten Versionen. Die offizielle `brew install openchat`-Formel wird vom Homebrew-Team gepflegt und seltener aktualisiert.
...
Sie können die Binärdatei auch aus [Releases](https://github.com/anomalyco/openchat/releases) abrufen.
...
Hier ist ein [Beispielgespräch](https://openchat.ai/s/4XP1fce5) mit OpenCode.
