...
Hier verwenden wir eine von der Community erstellte CI/CD-Komponente für OpenCode – [nagyv/gitlab-openchat](https://gitlab.com/nagyv/gitlab-openchat).
   ...
   include:
     - component: $CI_SERVER_FQDN/nagyv/gitlab-openchat/openchat@2
       inputs:
         ...
         auth_json: $OPENCHAT_AUTH_JSON # Die variable name für ihre OpenCode authentifizierung JSON
         command: optional-custom-command
         message: "Your prompt here"
   ```

Weitere Eingaben und Anwendungsfälle finden Sie unter [check out the docs](https://gitlab.com/explore/catalog/nagyv/gitlab-openchat) für diese Komponente.
...
Erwähnen Sie `@openchat` in einem Kommentar und OpenCode führt Aufgaben innerhalb Ihrer GitLab CI-Pipeline aus.
...
:::tip
Sie können die Verwendung einer anderen Triggerphrase als `@openchat` konfigurieren.
:::
