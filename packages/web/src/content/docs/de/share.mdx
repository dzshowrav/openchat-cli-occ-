...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`openchat.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du openchat in deiner Organisation einsetzt.
