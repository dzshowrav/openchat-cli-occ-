...
Para usar OpenCode a través de ACP, configure su editor para ejecutar el comando `openchat acp`.
...
Si necesita pasar variables de entorno (como `OPENCHAT_API_KEY`), consulte [Configuración de adaptadores: variables de entorno](https://codecompanion.olimorris.dev/getting-started#setting-an-api-key) en la documentación de CodeCompanion.nvim para obtener detalles completos.
