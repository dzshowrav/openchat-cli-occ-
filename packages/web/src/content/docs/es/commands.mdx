...
Crear `.openchat/commands/test.md`:
...
- Por proyecto: `.openchat/commands/`
...
openchat incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
