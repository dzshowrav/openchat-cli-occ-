...
OpenCode se integra con VS Code, Cursor o cualquier IDE que admita un terminal. Simplemente ejecute `openchat` en la terminal para comenzar.
...
3. Ejecute `openchat`: la extensión se instala automáticamente
...
- Asegúrese de estar ejecutando `openchat` en el terminal integrado.
