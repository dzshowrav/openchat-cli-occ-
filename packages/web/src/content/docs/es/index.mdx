...
![OpenCode TUI con el tema openchat](../../../assets/lander/screenshot.png)
...
- **Usando Homebrew en macOS y Linux**
  ...
  > Recomendamos utilizar el tap OpenCode para las versiones más actualizadas. La fórmula oficial `brew install openchat` la mantiene el equipo Homebrew y se actualiza con menos frecuencia.
...
También puede obtener el binario desde [Versiones](https://github.com/anomalyco/openchat/releases).
...
1. Ejecute el comando `/connect` en la TUI, seleccione openchat y diríjase a [openchat.ai/auth](https://openchat.ai/auth).
...
Aquí tiene una [conversación de ejemplo](https://openchat.ai/s/4XP1fce5) con OpenCode.
