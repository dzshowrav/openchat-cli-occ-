...
Aquí estamos utilizando un componente CI/CD creado por la comunidad para OpenCode — [nagyv/gitlab-openchat](https://gitlab.com/nagyv/gitlab-openchat).
...
Para obtener más entradas y casos de uso, [consulte los documentos](https://gitlab.com/explore/catalog/nagyv/gitlab-openchat) de este componente.
...
Mencione `@openchat` en un comentario y OpenCode ejecutará tareas dentro de su canal de CI GitLab.
...
:::tip
Puede configurarlo para utilizar una frase de activación diferente a `@openchat`.
:::
