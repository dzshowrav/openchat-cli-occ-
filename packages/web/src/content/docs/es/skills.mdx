...
- Configuración del proyecto: `.openchat/skills/<name>/SKILL.md`
- Configuración global: `~/.config/openchat/skills/<name>/SKILL.md`
...
Carga cualquier `skills/*/SKILL.md` coincidente en `.openchat/` y cualquier `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` coincidente a lo largo del camino.

Las definiciones globales también se cargan desde `~/.config/openchat/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` y `~/.agents/skills/*/SKILL.md`.
...
Crea `.openchat/skills/git-release/SKILL.md` así:
...
Controle a qué agentes de habilidades pueden acceder utilizando permisos basados ​​en patrones en `openchat.json`:
...
**Para agentes integrados** (en `openchat.json`):
