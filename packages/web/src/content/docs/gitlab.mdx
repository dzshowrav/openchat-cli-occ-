...
Here we are using a community-created CI/CD component for OpenCode — [nagyv/gitlab-openchat](https://gitlab.com/nagyv/gitlab-openchat).
...
For more inputs and use cases [check out the docs](https://gitlab.com/explore/catalog/nagyv/gitlab-openchat) for this component.
...
Mention `@openchat` in a comment, and OpenCode will execute tasks within your GitLab CI pipeline.
...
:::tip
You can configure to use a different trigger phrase than `@openchat`.
:::
