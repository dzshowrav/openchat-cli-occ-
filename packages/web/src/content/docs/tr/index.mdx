...
![openchat TUI with the openchat theme](../../../assets/lander/screenshot.png)
...
- **Homebrew'u macOS ve Linux'ta kullanma**
  ...
  > En güncel sürümler için OpenCode tap'ini kullanmanızı öneririz. Resmi `brew install openchat` formülü Homebrew ekibi tarafından korunur ve daha sık güncellenir.
...
İkili dosyayı [Releases](https://github.com/anomalyco/openchat/releases)'dan da alabilirsiniz.
...
1. TUI'de `/connect` komutunu çalıştırın, OpenCode'u seçin ve [openchat.ai/auth](https://openchat.ai/auth)'ye gidin.
...
İşte OpenCode ile bir [örnek konuşma](https://openchat.ai/s/4XP1fce5).
