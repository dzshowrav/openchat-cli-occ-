---
title: Paylasim
description: openchat konusmalarini genel baglantilarla paylasin.
---

openchat'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda openchat:
...
openchat, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak openchat manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `openchat.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda openchat kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
