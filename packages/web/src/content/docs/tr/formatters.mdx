...
description: openchat dile özgü biçimlendiriciler kullanır.
---

openchat, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

openchat, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, openchat bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

openchat bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri openchat yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
