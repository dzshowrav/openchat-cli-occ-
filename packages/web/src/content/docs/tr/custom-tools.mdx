---
title: Özel Araçlar
description: LLM'un openchat'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. openchat'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.openchat/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/openchat/tools/` içine yerleştirerek.
