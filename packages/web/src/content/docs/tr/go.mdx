...
OpenCode yapılandırmanızdaki [model id](/docs/config/#models) formatı `openchat-go/<model-id>` şeklindedir. Örneğin, Kimi K3 için yapılandırmanızda `openchat-go/kimi-k3` kullanmalısınız.
