...
- **Using Homebrew on macOS and Linux**
  ...
  > We recommend using the OpenCode tap for the most up to date releases. The official `brew install openchat` formula is maintained by the Homebrew team and is updated less frequently.
...
You can also grab the binary from the [Releases](https://github.com/anomalyco/openchat/releases).
...
1. Run the `/connect` command in the TUI, select openchat, and head to [openchat.ai/auth](https://openchat.ai/auth).
...
Here's an [example conversation](https://openchat.ai/s/4XP1fce5) with OpenCode.
