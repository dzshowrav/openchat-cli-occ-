...
![واجهة OpenCode في terminal مع سمة openchat](../../../assets/lander/screenshot.png)
...
- **باستخدام Homebrew على macOS وLinux**
  ...
  > نوصي باستخدام tap الخاص بـ OpenCode للحصول على أحدث الإصدارات. صيغة `brew install openchat` الرسمية تُدار بواسطة فريق Homebrew ويتم تحديثها بوتيرة أقل.
...
يمكنك أيضا تنزيل الملف التنفيذي من صفحة [Releases](https://github.com/anomalyco/openchat/releases).
...
1. شغّل الأمر `/connect` في واجهة TUI، واختر openchat، ثم انتقل إلى [openchat.ai/auth](https://openchat.ai/auth).
...
إليك [مثالا لمحادثة](https://openchat.ai/s/4XP1fce5) مع OpenCode.
