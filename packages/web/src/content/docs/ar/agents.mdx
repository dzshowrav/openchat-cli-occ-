...
هيّئ الوكلاء في ملف إعدادات `openchat.json`:
...
- عام: `~/.config/openchat/agents/`
- لكل مشروع: `.openchat/agents/`
...
يستخدم معرّف النموذج في إعدادات OpenCode الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [OpenCode Zen](/docs/zen)، فستستخدم `openchat/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `openchat models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/anomalyco/openchat).
:::
