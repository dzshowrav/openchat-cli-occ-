...
هذا منفصل عن `openchat.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
استخدم `OPENCHAT_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `openchat.default`.
