...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في openchat.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في openchat مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.openchat/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/openchat/tools/`.
