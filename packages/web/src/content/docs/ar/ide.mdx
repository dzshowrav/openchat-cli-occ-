...
يتكامل OpenCode مع VS Code و Cursor أو أي IDE يدعم terminal. ما عليك سوى تشغيل `openchat` في terminal للبدء.
...
3. شغّل `openchat` - سيتم تثبيت الامتداد تلقائيا
...
- تأكد من أنك تشغّل `openchat` داخل terminal المدمجة.
