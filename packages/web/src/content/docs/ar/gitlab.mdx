...
هنا نستخدم مكوّن CI/CD أنشأه المجتمع لـ OpenCode — [nagyv/gitlab-openchat](https://gitlab.com/nagyv/gitlab-openchat).
...
لمزيد من المُدخلات وحالات الاستخدام، [اطّلع على الوثائق](https://gitlab.com/explore/catalog/nagyv/gitlab-openchat) الخاصة بهذا المكوّن.
...
اذكر `@openchat` في تعليق، وسينفّذ OpenCode المهام ضمن خط أنابيب GitLab CI لديك.
...
:::tip
يمكنك ضبطه لاستخدام عبارة تشغيل مختلفة عن `@openchat`.
:::
