...
أنشئ الملف `.openchat/commands/test.md`:
...
- على مستوى النظام: `~/.config/openchat/commands/`
- لكل مشروع: `.openchat/commands/`
...
يتضمن openchat عدة أوامر مضمنة مثل `/init` و`/undo` و`/redo` و`/share` و`/help`؛ [اعرف المزيد](/docs/tui#commands).
