...
يستخدم [معرّف النموذج](/docs/config/#models) في إعدادات OpenCode الصيغة `openchat/<model-id>`. على سبيل المثال، بالنسبة إلى GPT 5.5، ستستخدم `openchat/gpt-5.5` في إعداداتك.
