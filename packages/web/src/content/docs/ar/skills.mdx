...
- إعدادات المشروع: `.openchat/skills/<name>/SKILL.md`
- إعدادات عامة: `~/.config/openchat/skills/<name>/SKILL.md`
...
ويحمّل أي ملفات مطابقة لـ `skills/*/SKILL.md` داخل `.openchat/` وأي ملفات مطابقة لـ `.claude/skills/*/SKILL.md` أو `.agents/skills/*/SKILL.md` على طول الطريق.

كما تُحمَّل التعريفات العامة أيضاً من `~/.config/openchat/skills/*/SKILL.md` و `~/.claude/skills/*/SKILL.md` و `~/.agents/skills/*/SKILL.md`.
...
أنشئ `.openchat/skills/git-release/SKILL.md` بهذا الشكل:
...
تحكم في المهارات التي يمكن للوكلاء الوصول إليها باستخدام صلاحيات مبنية على أنماط داخل `openchat.json`:
...
**للوكلاء المدمجين** (في `openchat.json`):
