...
لاستخدام OpenCode عبر ACP، اضبط محررك ليشغّل الأمر `openchat acp`.
...
إذا احتجت إلى تمرير متغيرات البيئة (مثل `OPENCHAT_API_KEY`)، فارجع إلى [Configuring Adapters: Environment Variables](https://codecompanion.olimorris.dev/getting-started#setting-an-api-key) ضمن توثيق CodeCompanion.nvim للاطلاع على التفاصيل كاملة.
