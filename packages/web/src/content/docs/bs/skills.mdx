...
- Konfiguracija projekta: `.openchat/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/openchat/skills/<name>/SKILL.md`
...
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.openchat/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/openchat/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.openchat/skills/git-release/SKILL.md` ovako:
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `openchat.json`:
...
**Za ugradene agente** (u `openchat.json`):
