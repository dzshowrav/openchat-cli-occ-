...
![OpenCode TUI sa openchat temom](../../../assets/lander/screenshot.png)
Hajde da počnemo.
...
> Preporučujemo korištenje OpenCode tap za najnovija izdanja. Službenu formulu `brew install openchat` održava Homebrew tim i ažurira se rjeđe.
...
Također možete preuzeti binarnu datoteku iz [Releases](https://github.com/anomalyco/openchat/releases).
...
:::
Evo [primjer razgovora](https://openchat.ai/s/4XP1fce5) sa OpenCode.
