...
Konfigurirajte agente u svom konfiguracijskom fajlu `openchat.json`:
...
- Globalno: `~/.config/openchat/agents/`
- Po projektu: `.openchat/agents/`
...
ID modela u vašoj OpenCode konfiguraciji koristi format `provider/model-id`. Na primjer, ako koristite [OpenCode Zen](/docs/zen), koristili biste `openchat/gpt-5.1-codex` za GPT 5.1 Codex.
...
:::tip
Pokrenite `openchat models` da vidite listu dostupnih modela.
:::
...
:::tip
Imate li agenta kojeg biste željeli podijeliti? [Pošalji PR](https://github.com/anomalyco/openchat).
:::
