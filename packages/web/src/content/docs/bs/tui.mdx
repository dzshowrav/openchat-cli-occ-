...
Ovo je odvojeno od `openchat.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `OPENCHAT_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `openchat.default`.
