...
Ovdje koristimo CI/CD komponentu kreiranu u zajednici za OpenCode — [nagyv/gitlab-openchat](https://gitlab.com/nagyv/gitlab-openchat).
...
Za više unosa i slučajeva upotrebe [pogledajte dokumente docs](https://gitlab.com/explore/catalog/nagyv/gitlab-openchat) za ovu komponentu.
...
Spomenite `@openchat` u komentaru i OpenCode će izvršiti zadatke unutar vašeg GitLab CI cevovoda.
...
:::tip
Možete konfigurirati da koristite drugu frazu okidača od `@openchat`.
:::
