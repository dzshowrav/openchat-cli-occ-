...
OpenCode se integriše sa VS kodom, Cursor-om ili bilo kojim IDE-om koji podržava terminal. Samo pokrenite `openchat` u terminalu da započnete.
...
3. Pokrenite `openchat` - ekstenzija se automatski instalira
...
- Uvjerite se da koristite `openchat` u integriranom terminalu.
