---
title: SDK
description: Type-safe JS client for openchat server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The openchat JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control openchat programmatically.
...
Create an instance of openchat:
...
You can pass a configuration object to customize behavior. The instance still picks up your `openchat.json`, but you can override or add configuration inline:
...
If you already have a running instance of openchat, you can create a client instance to connect to it:
