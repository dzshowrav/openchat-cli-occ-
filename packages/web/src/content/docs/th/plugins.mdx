...
- `.openchat/plugins/` - ​​ปลั๊กอินระดับโครงการ
- `~/.config/openchat/plugins/` - ​​ปลั๊กอินทั่วโลก
...
**ปลั๊กอิน npm** ได้รับการติดตั้งโดยอัตโนมัติโดยใช้ Bun เมื่อเริ่มต้น แพ็คเกจและการขึ้นต่อกันถูกแคชไว้ใน `~/.cache/openchat/node_modules/`
...
1. การกำหนดค่าส่วนกลาง (`~/.config/openchat/openchat.json`)
2. การกำหนดค่าโครงการ (`openchat.json`)
3. ไดเร็กทอรีปลั๊กอินสากล (`~/.config/openchat/plugins/`)
4. ไดเรกทอรีปลั๊กอินโครงการ (`.openchat/plugins/`)
...
- `client`: ไคลเอนต์ openchat SDK สำหรับการโต้ตอบกับ AI
...
นี่คือตัวอย่างบางส่วนของปลั๊กอินที่คุณสามารถใช้เพื่อขยาย openchat
...
ป้องกันไม่ให้ openchat อ่านไฟล์ `.env`:
...
ปลั๊กอินยังสามารถเพิ่มเครื่องมือที่กำหนดเองให้กับ openchat:
...
ตัวช่วย `tool` สร้างเครื่องมือแบบกำหนดเองที่สามารถเรียกใช้ openchat ได้ ใช้ฟังก์ชัน Zod schema และส่งกลับคำจำกัดความของเครื่องมือด้วย:
...
เครื่องมือที่คุณกำหนดเองจะพร้อมใช้งานสำหรับ openchat ควบคู่ไปกับเครื่องมือในตัว
...
ระดับ: `debug`, `info`, `warn`, `error` ดู[SDKเอกสารประกอบ](https://openchat.ai/docs/sdk)สำหรับรายละเอียด
