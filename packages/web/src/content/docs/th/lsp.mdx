...
:::note
คุณสามารถปิดใช้งานการดาวน์โหลดเซิร์ฟเวอร์ LSP อัตโนมัติได้โดยตั้งค่าตัวแปรสภาพแวดล้อม `OPENCHAT_DISABLE_LSP_DOWNLOAD` เป็น `true`
:::
...
เมื่อเปิดใช้งาน LSP และ openchat เปิดไฟล์ มันจะ:
...
คุณสามารถเปิดใช้งานและปรับแต่งเซิร์ฟเวอร์ LSP ผ่านส่วน `lsp` ในการกำหนดค่า openchat
