...
- การกำหนดค่าโครงการ: `.openchat/skills/<name>/SKILL.md`
- การกำหนดค่าส่วนกลาง: `~/.config/openchat/skills/<name>/SKILL.md`
...
โดยจะโหลด `skills/*/SKILL.md` ที่ตรงกันใน `.openchat/` และ `.claude/skills/*/SKILL.md` หรือ `.agents/skills/*/SKILL.md` ที่ตรงกันตลอดทาง

คำจำกัดความสากลยังโหลดจาก `~/.config/openchat/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` และ `~/.agents/skills/*/SKILL.md`
...
สร้าง `.openchat/skills/git-release/SKILL.md` แบบนี้:
...
ควบคุมว่าตัวแทนทักษะใดสามารถเข้าถึงโดยใช้สิทธิ์ตามรูปแบบใน `openchat.json`:
...
**สำหรับตัวแทนในตัว** (ใน `openchat.json`):
