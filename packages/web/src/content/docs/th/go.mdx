...
[model id](/docs/config/#models) ใน OpenCode config ของคุณจะใช้รูปแบบ `openchat-go/<model-id>` ตัวอย่างเช่น สำหรับ Kimi K3 คุณจะใช้ `openchat-go/kimi-k3` ใน config ของคุณ
