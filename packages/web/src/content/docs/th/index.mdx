...
![OpenCode TUI พร้อม openchat theme](../../../assets/lander/screenshot.png)
...
- **ใช้ Homebrew บน macOS และ Linux**
  ...
  > เราขอแนะนำให้ใช้ OpenCode tap เพื่อเผยแพร่ข้อมูลล่าสุด สูตร `brew install openchat` อย่างเป็นทางการได้รับการดูแลโดยทีมงาน Homebrew และมีการอัปเดตไม่บ่อยนัก
...
คุณยังสามารถคว้าไบนารี่ได้จาก [เผยแพร่](https://github.com/anomalyco/openchat/releases)
...
นี่คือ [ตัวอย่างการสนทนา](https://openchat.ai/s/4XP1fce5) กับ OpenCode
