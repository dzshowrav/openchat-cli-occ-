...
[model id](/docs/config/#models) ใน OpenCode config ของคุณใช้รูปแบบ `openchat/<model-id>` ตัวอย่างเช่น สำหรับ GPT 5.5 คุณจะใช้ `openchat/gpt-5.5` ใน config ของคุณ
