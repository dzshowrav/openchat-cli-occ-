...
กำหนดค่าเอเจนต์ในไฟล์ `openchat.json` ของคุณ:
...
- ระดับผู้ใช้ (Global): `~/.config/openchat/agents/`
- ระดับโปรเจ็กต์: `.openchat/agents/`
...
:::tip
ใช้ `openchat models` เพื่อดูรายการตัวเลือกทั้งหมด
:::
...
:::tip
คุณมีเอเจนต์เจ๋งๆ ที่ต้องการแบ่งปันหรือไม่? [ส่ง PR มาที่นี่](https://github.com/anomalyco/openchat)
:::
