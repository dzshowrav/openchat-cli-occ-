...
สิ่งนี้แยกจาก `openchat.json` ซึ่งกำหนดค่าพฤติกรรมเซิร์ฟเวอร์/รันไทม์
...
ใช้ `OPENCHAT_TUI_CONFIG` เพื่อโหลดเส้นทางการกำหนดค่า TUI แบบกำหนดเอง
...
- `sound_pack` - sound pack ID ที่จะใช้ ค่าเริ่มต้นคือ `openchat.default`
