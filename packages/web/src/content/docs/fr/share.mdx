...
Pour appliquer cela au sein de votre équipe pour un projet donné, ajoutez-le au `openchat.json` dans votre projet et enregistrez-vous dans Git.
...
[En savoir plus](/docs/enterprise) sur l'utilisation de openchat dans votre organisation.
