...
- Configuration du projet : `.openchat/skills/<name>/SKILL.md`
- Configuration globale : `~/.config/openchat/skills/<name>/SKILL.md`
...
Il charge tout `skills/*/SKILL.md` correspondant dans `.openchat/` et tout `.claude/skills/*/SKILL.md` ou `.agents/skills/*/SKILL.md` correspondant en cours de route.

Les définitions globales sont également chargées à partir de `~/.config/openchat/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` et `~/.agents/skills/*/SKILL.md`.
...
Créez `.openchat/skills/git-release/SKILL.md` comme ceci :
...
Contrôlez les compétences auxquelles les agents peuvent accéder à l'aide d'autorisations basées sur des modèles dans `openchat.json` :
...
**Pour les agents intégrés** (dans `openchat.json`) :
