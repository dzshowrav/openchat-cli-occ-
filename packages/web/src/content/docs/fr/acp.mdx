...
Pour utiliser OpenCode via ACP, configurez votre éditeur pour exécuter la commande `openchat acp`.
...
Si vous devez transmettre des variables d'environnement (comme `OPENCHAT_API_KEY`), reportez-vous à [Configuring Adapters: Environment Variables](https://codecompanion.olimorris.dev/getting-started#setting-an-api-key) dans la documentation CodeCompanion.nvim pour plus de détails.
