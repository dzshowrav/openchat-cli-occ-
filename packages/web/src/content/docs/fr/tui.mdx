...
Ceci est séparé de `openchat.json`, qui configure le comportement du serveur/d'exécution.
...
Utilisez `OPENCHAT_TUI_CONFIG` pour charger un chemin de configuration TUI personnalisé.
...
- `sound_pack` - ID du sound pack à utiliser. Valeur par défaut : `openchat.default`.
