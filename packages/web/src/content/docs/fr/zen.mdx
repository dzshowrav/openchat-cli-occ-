...
Le [model id](/docs/config/#models) dans votre configuration OpenCode utilise le format `openchat/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `openchat/gpt-5.5` dans votre configuration.
