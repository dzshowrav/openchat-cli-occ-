...
![OpenCode TUI avec le thème openchat](../../../assets/lander/screenshot.png)
...
- **Via Homebrew sur macOS et Linux**
  ...
  > Nous vous recommandons d'utiliser le tap OpenCode pour les versions les plus récentes. La formule officielle `brew install openchat` est maintenue par l'équipe Homebrew et est mise à jour moins fréquemment.
...
Vous pouvez également récupérer le binaire dans les [Releases](https://github.com/anomalyco/openchat/releases).
...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez openchat et allez sur [openchat.ai/auth](https://openchat.ai/auth).
...
Voici un [exemple de conversation](https://openchat.ai/s/4XP1fce5) avec OpenCode.
