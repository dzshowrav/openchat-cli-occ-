...
Aby używać OpenCode przez ACP, skonfiguruj swój edytor tak, aby uruchamiał polecenie `openchat acp`.
...
Jeśli wymagany jest `OPENCHAT_API_KEY`, zapoznaj się z sekcją [Konfigurowanie adapterów: Zmienne środowiskowe](https://codecompanion.olimorris.dev/getting-started#setting-an-api-key) w dokumentacji CodeCompanion.nvim, aby uzyskać szczegółowe informacje.
