---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala openchat.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

openchat zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie openchat uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI openchat, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do openchat. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij openchat. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `openchat.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `OPENCHAT_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `openchat.default`.
