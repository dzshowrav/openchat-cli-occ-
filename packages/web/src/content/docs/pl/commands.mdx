...
Utwórz `.openchat/commands/test.md`:
...
Możesz zdefiniować polecenia w `openchat.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji openchat:
...
- Globalnie: `~/.config/openchat/commands/`
- Na projekt: `.openchat/commands/`
...
openchat zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
