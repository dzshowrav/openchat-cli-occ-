---
title: Bedrift
description: Sikker bruk av openchat i din organisasjon.
---
...
Hvis en bruker aktiverer funksjonen `/share`, sendes samtalen og dataene knyttet til den til tjenesten vi bruker til å være vert for disse delesidene på openchat.ai.
