...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `openchat.json` i prosjektet ditt og sjekk det inn i Git.
...
[Finn ut mer](/docs/enterprise) om bruk av openchat i organisasjonen din.
