...
- `.openchat/plugins/` - Programtillegg på prosjektnivå
...
**npm-plugins** installeres automatisk ved hjelp av Bun ved oppstart. Pakker og deres avhengigheter er bufret i `~/.cache/openchat/node_modules/`.
...
1. Global konfigurasjon (`~/.config/openchat/openchat.json`)
2. Prosjektkonfigurasjon (`openchat.json`)
3. Global plugin-katalog (`~/.config/openchat/plugins/`)
4. Prosjektpluginkatalog (`.openchat/plugins/`)
...
Nivåer: `debug`, `info`, `warn`, `error`. Se [SDK dokumentasjon](https://openchat.ai/docs/sdk) for detaljer.
