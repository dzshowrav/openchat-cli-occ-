---
title: TUI
description: Bruke openchat-terminalbrukergrensesnittet.
---
...
Dette er atskilt fra `openchat.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `OPENCHAT_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `openchat.default`.
