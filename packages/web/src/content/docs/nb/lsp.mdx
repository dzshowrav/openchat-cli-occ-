---
title: LSP-servere
description: openchat integreres med LSP-serverne dine.
---
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `OPENCHAT_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og openchat åpner en fil, gjør den:
