---
title: GitLab
description: Bruk openchat i GitLab-problemer og Merge Requests.
---
...
Her bruker vi en fellesskapsskapt CI/CD-komponent for OpenCode — [nagyv/gitlab-openchat](https://gitlab.com/nagyv/gitlab-openchat).
...
For flere inndata og brukstilfeller [sjekk ut dokumentene](https://gitlab.com/explore/catalog/nagyv/gitlab-openchat) for denne komponenten.
...
Nevn `@openchat` i en kommentar, og OpenCode vil utføre oppgaver innenfor din GitLab CI-pipeline.
