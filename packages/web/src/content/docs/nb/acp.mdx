---
title: ACP-støtte
description: Bruk openchat i en hvilken som helst ACP-kompatibel editor.
---
...
For å bruke OpenCode via ACP, konfigurer redigeringsprogrammet til å kjøre kommandoen `openchat acp`.
...
Hvis du trenger å sende miljøvariabler (som `OPENCHAT_API_KEY`), se [Konfigurere adaptere: miljøvariabler](https://codecompanion.olimorris.dev/getting-started#setting-an-api-key) i CodeCompanion.nvim-dokumentasjonen for fullstendige detaljer.
