...
- **Bruke Homebrew på macOS og Linux**
  ...
  > Vi anbefaler å bruke OpenCode-tappen for de mest oppdaterte utgivelsene. Den offisielle `brew install openchat`-formelen vedlikeholdes av Homebrew-teamet og oppdateres sjeldnere.
...
Du kan også hente binæren fra [Releases](https://github.com/anomalyco/openchat/releases).
...
1. Kjør kommandoen `/connect` i TUI, velg OpenCode og gå til [openchat.ai/auth](https://openchat.ai/auth).
