...
OpenCode integreres med VS Code, Cursor eller en hvilken som helst IDE som støtter en terminal. Bare kjør `openchat` i terminalen for å komme i gang.
...
3. Kjør `openchat` - utvidelsen installeres automatisk
...
- Sørg for at du kjører `openchat` i den integrerte terminalen.
