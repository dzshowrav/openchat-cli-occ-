...
Brug den til at bygge integrasjoner og kontrollere openchat programmatisk.
...
Opret en forekomst av openchat:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `openchat.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av openchat, kan du oprete en klientforekomst for at koble til den:
