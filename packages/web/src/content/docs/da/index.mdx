...
![OpenCode TUI med openchat-temaet](../../../assets/lander/screenshot.png)
...
- **Brug af Homebrew på macOS og Linux**
  ...
  > Vi anbefaler at bruge OpenCode-tap for at få de mest opdaterede udgivelser. Den officielle `brew install openchat`-formel vedligeholdes af Homebrew-teamet og opdateret sjældnere.
...
Du kan også få fat i binæren fra [Releases](https://github.com/anomalyco/openchat/releases).
...
Her er en [eksempelsamtale](https://openchat.ai/s/4XP1fce5) med OpenCode.
