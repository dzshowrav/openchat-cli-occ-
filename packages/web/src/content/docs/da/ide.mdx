...
OpenCode integreres med VS Code, Cursor eller enhver IDE, der understøtter en terminal. Bare kør `openchat` i terminalen for at komme i gang.
...
3. Kør `openchat` - udvidelsen installeres automatisk
...
- Sørg for, at du kører `openchat` i den integrerede terminal.
