...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `OPENCHAT_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og openchat åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din openchat-konfiguration.
