...
Her bruger vi en community-skabt CI/CD-komponent til OpenCode — [nagyv/gitlab-openchat](https://gitlab.com/nagyv/gitlab-openchat).
...
For flere input og use cases [check out the docs](https://gitlab.com/explore/catalog/nagyv/gitlab-openchat) for denne komponent.
...
Nævn `@openchat` i en kommentar, og OpenCode vil udføre opgaver i din GitLab CI-pipeline.
...
:::tip
Du kan konfigurere til at bruge en anden udløsersætning end `@openchat`.
:::
