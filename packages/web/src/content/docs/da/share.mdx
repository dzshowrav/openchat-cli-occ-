...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `openchat.json` i prosjektet ditt og tjek inn i Git.
...
[Finn ut mer](/docs/enterprise) om brug av openchat i organisasjonen din.
