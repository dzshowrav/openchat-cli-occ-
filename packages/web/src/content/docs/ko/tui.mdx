...
이는 서버/런타임 동작을 구성하는 `openchat.json`과는 별개입니다.
...
`OPENCHAT_TUI_CONFIG`를 사용하여 사용자 정의 TUI 설정 경로를 로드할 수 있습니다.
...
- `sound_pack` - 사용할 sound pack ID입니다. 기본값은 `openchat.default`입니다.
