...
여기서는 OpenCode용 커뮤니티 제작 CI/CD component인 [nagyv/gitlab-openchat](https://gitlab.com/nagyv/gitlab-openchat)를 사용합니다.
...
더 많은 입력값과 사용 사례는 이 component의 [docs](https://gitlab.com/explore/catalog/nagyv/gitlab-openchat)에서 확인하세요.
...
댓글에서 `@openchat`를 멘션하면 OpenCode가 GitLab CI 파이프라인 안에서 작업을 실행합니다.
...
:::tip
`@openchat` 대신 다른 trigger phrase를 사용하도록 설정할 수 있습니다.
:::
