...
这里我们使用的是社区创建的 OpenCode CI/CD 组件 — [nagyv/gitlab-openchat](https://gitlab.com/nagyv/gitlab-openchat)。
...
有关更多输入参数和使用场景，请[查看该组件的文档](https://gitlab.com/explore/catalog/nagyv/gitlab-openchat)。
...
在评论中提及 `@openchat`，OpenCode 将在你的 GitLab CI 流水线中执行任务。
