...
description: Crea strumenti che l'LLM puo chiamare in openchat.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di openchat come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.openchat/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/openchat/tools/`.
