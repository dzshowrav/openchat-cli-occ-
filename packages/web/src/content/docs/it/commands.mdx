...
Crea `.openchat/commands/test.md`:
...
- Globale: `~/.config/openchat/commands/`
- Per progetto: `.openchat/commands/`
...
openchat include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
