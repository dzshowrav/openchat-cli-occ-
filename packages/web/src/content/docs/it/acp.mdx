...
Per usare OpenCode via ACP, configura l'editor in modo che esegua il comando `openchat acp`.
...
Se devi passare variabili d'ambiente (come `OPENCHAT_API_KEY`), vedi [Configuring Adapters: Environment Variables](https://codecompanion.olimorris.dev/getting-started#setting-an-api-key) nella documentazione di CodeCompanion.nvim.
