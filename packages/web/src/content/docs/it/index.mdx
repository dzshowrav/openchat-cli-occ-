...
![OpenCode TUI con il tema openchat](../../../assets/lander/screenshot.png)
...
- **Con Homebrew su macOS e Linux**
  ...
  > Ti consigliamo di usare il tap di OpenCode per avere le release piu aggiornate. La formula ufficiale `brew install openchat` e mantenuta dal team Homebrew e viene aggiornata meno spesso.
...
Puoi anche scaricare il binario dalle [Releases](https://github.com/anomalyco/openchat/releases).
...
1. Esegui il comando `/connect` nella TUI, seleziona openchat e vai su [openchat.ai/auth](https://openchat.ai/auth).
...
Ecco un'[esempio di conversazione](https://openchat.ai/s/4XP1fce5) con OpenCode.
