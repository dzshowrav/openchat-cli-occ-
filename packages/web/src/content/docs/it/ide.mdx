...
OpenCode si integra con VS Code, Cursor o qualunque IDE che supporti un terminale. Basta eseguire `openchat` nel terminale per iniziare.
...
3. Esegui `openchat` - l'estensione si installa automaticamente
...
- Assicurati di eseguire `openchat` nel terminale integrato.
