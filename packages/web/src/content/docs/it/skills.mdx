...
- Config di progetto: `.openchat/skills/<name>/SKILL.md`
- Config globale: `~/.config/openchat/skills/<name>/SKILL.md`
...
Carica qualsiasi `skills/*/SKILL.md` corrispondente in `.openchat/` e qualsiasi `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` corrispondente lungo il percorso.

Le definizioni globali vengono caricate anche da `~/.config/openchat/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` e `~/.agents/skills/*/SKILL.md`.
...
Crea `.openchat/skills/git-release/SKILL.md` cosi':
...
Controlla a quali skill gli agenti possono accedere usando permessi basati su pattern in `openchat.json`:
...
**Per agenti integrati** (in `openchat.json`):
