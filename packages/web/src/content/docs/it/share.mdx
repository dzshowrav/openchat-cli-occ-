...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `openchat.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare openchat nella tua organizzazione.
