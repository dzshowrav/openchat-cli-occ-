...
Qui usiamo un componente CI/CD creato dalla community per OpenCode — [nagyv/gitlab-openchat](https://gitlab.com/nagyv/gitlab-openchat).
...
Per altri input e casi d'uso, [consulta la documentazione](https://gitlab.com/explore/catalog/nagyv/gitlab-openchat) di questo componente.
...
Menziona `@openchat` in un commento e OpenCode eseguira' i task dentro la tua pipeline GitLab CI.
...
:::tip
Puoi configurare una frase trigger diversa da `@openchat`.
:::
