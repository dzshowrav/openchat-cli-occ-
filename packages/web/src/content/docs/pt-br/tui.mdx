---
title: TUI
description: Usando a interface de usuário de terminal openchat.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O openchat fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar openchat inicia o TUI para o diretório atual.
...
Ao usar o TUI do openchat, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao openchat. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do openchat. _Aliases_: `/quit`, `/q`
...
Isso é separado do `openchat.json`, que configura o comportamento do servidor/runtime.
...
Use `OPENCHAT_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
...
- `sound_pack` - ID do sound pack a ser usado. O padrão é `openchat.default`.
