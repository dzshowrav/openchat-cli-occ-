...
O [model id](/docs/config/#models) na sua configuração do OpenCode usa o formato `openchat/<model-id>`. Por exemplo, para GPT 5.5, você usaria `openchat/gpt-5.5` na sua configuração.
