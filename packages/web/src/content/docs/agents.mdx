...
Configure agents in your `openchat.json` config file:
...
The model ID in your OpenCode config uses the format `provider/model-id`. For example, if you're using [OpenCode Zen](/docs/zen), you would use `openchat/gpt-5.1-codex` for GPT 5.1 Codex.
...
:::tip
Run `openchat models` to see a list of the available models.
:::
...
:::tip
Do you have an agent you'd like to share? [Submit a PR](https://github.com/anomalyco/openchat).
:::
