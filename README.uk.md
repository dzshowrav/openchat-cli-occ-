...
brew install anomalyco/tap/openchat # macOS і Linux (рекомендовано, завжди актуально)
...
nix run nixpkgs#openchat           # або github:anomalyco/openchat для найновішої dev-гілки
```
...
OpenCode також доступний як десктопний застосунок. Завантажуйте напряму зі [сторінки релізів](https://github.com/anomalyco/openchat/releases) або [openchat.ai/download](https://openchat.ai/download).
...
Щоб дізнатися більше про налаштування OpenCode, [**перейдіть до нашої документації**](https://openchat.ai/docs).
...
Якщо ви працюєте над проєктом, пов'язаним з OpenCode, і використовуєте "openchat" у назві, наприклад "openchat-dashboard" або "openchat-mobile", додайте примітку до свого README.
