...
1. `$OPENCHAT_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.openchat/bin` - ডিফল্ট ফলব্যাক
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://openchat.ai/docs/agents)।
...
**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/openchat) | [X.com](https://x.com/openchat)
